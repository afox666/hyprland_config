...
local terminal    = "/usr/bin/ghostty --gtk-single-instance=false"
...
hl.bind("CTRL + SHIFT + A", hl.dsp.exec_cmd(flameshotGui))
...
-- Scratchpad drawer
hl.bind(mainMod .. " + S",         hl.dsp.exec_cmd(scratchpad .. " toggle"))
hl.bind(mainMod .. " + SHIFT + S", hl.dsp.exec_cmd(scratchpad .. " push"))
hl.bind(mainMod .. " + ALT + S",   hl.dsp.exec_cmd(scratchpad .. " pop"))

-- Scroll through existing workspaces with mainMod + scroll
hl.bind(mainMod .. " + mouse_down", hl.dsp.focus({ workspace = "e+1" }))
hl.bind(mainMod .. " + mouse_up",   hl.dsp.focus({ workspace = "e-1" }))

-- Move/resize windows with mouseMod + LMB/RMB and dragging
...
hl.window_rule({
    -- Keep Remmina in the tiled layer so it does not cover other tiled windows.
    name  = "tile-remmina",
